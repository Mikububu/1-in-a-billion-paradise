/**
 * Gene Keys Calculation Module
 * Ported from Python implementation.
 * Uses the same zodiacal wheel as Human Design.
 */
 ...
 */
export const tropicalLongitudeToGeneKey = (longitude: number): GeneKeyPosition => {
    ...
    // Use a proper modulus for negative numbers if ever input (though inputs should be 0-360)
 ...
 * - Pearl: Conscious Sun
 * 
 * @param planetaryPositions dict with 'personality' and 'design' sub-dicts
 * @returns {HologeneticProfile} dict with all hologenetic profile spheres
 */
export const calculateHologeneticProfile = (
