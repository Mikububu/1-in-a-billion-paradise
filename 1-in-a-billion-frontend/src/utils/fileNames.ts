 ...
 * Format: PersonName_SystemName_audio.m4a
 * NOTE: Backend outputs M4A format (AAC audio in MP4 container)
 */
export const generateAudioFilename = (
  ...
  return `${cleanPerson}_${cleanSystem}_audio.m4a`;
};
 ...
 * NOTE: Songs from MiniMax are MP3 format
 */
