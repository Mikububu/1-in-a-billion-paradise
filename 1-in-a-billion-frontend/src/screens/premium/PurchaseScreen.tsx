        ...
        return {
          ...
          products: [
            ...
            })),
            {
              ...
              meta: `${PRODUCTS.complete_reading.pagesMin} pages · ${formatAudioDuration(PRODUCTS.complete_reading.audioMinutes)} audio · Save $${(PRODUCTS.single_system.priceUSD * 5) - PRODUCTS.complete_reading.priceUSD}`,
              isBundle: true,
            },
          ],
        };
