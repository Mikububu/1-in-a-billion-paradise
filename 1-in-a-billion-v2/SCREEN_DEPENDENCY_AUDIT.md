...
- Incoming interactions: 1
  - `src/screens/onboarding/IntroScreen.tsx:223` via `navigate(SignIn)`
...
- Incoming interactions: 5
  ...
  - `src/screens/home/MyLibraryScreen.tsx:284` via `navigate(ComparePeople)`
...
- Incoming interactions: 8
  ...
  - `src/screens/home/PartnerReadingsScreen.tsx:123` via `navigate(EditBirthData)`
  - `src/screens/home/PartnerReadingsScreen.tsx:130` via `navigate(EditBirthData)`
  - `src/screens/home/PersonProfileScreen.tsx:112` via `navigate(EditBirthData)`
  - `src/screens/home/PersonProfileScreen.tsx:135` via `navigate(EditBirthData)`
  - `src/screens/home/PersonProfileScreen.tsx:146` via `navigate(EditBirthData)`
...
- Incoming interactions: 6
  ...
  - `src/screens/home/PartnerCoreIdentitiesScreen.tsx:628` via `reset(Home)`
...
- Incoming interactions: 3
  ...
  - `src/screens/home/MyLibraryScreen.tsx:250` via `navigate(JobDetail)`
  - `src/screens/home/PersonReadingsScreen.tsx:209` via `navigate(JobDetail)`
...
- Incoming interactions: 4
  ...
  - `src/screens/settings/SettingsScreen.tsx:213` via `navigate(MyLibrary)`
- Outgoing route targets: `ComparePeople`, `JobDetail`, `PeopleList`, `PersonPhotoUpload`, `Settings`, `SystemsOverview`, `YourChart`
...
- Incoming interactions: 7
  ...
  - `src/screens/home/PartnerReadingsScreen.tsx:121` via `navigate(PartnerInfo)`
  - `src/screens/home/PartnerReadingsScreen.tsx:125` via `navigate(PartnerInfo)`
  - `src/screens/home/PeopleListScreen.tsx:128` via `navigate(PartnerInfo)`
  - `src/screens/home/PeopleListScreen.tsx:95` via `navigate(PartnerInfo)`
  - `src/screens/home/SynastryOptionsScreen.tsx:91` via `navigate(PartnerInfo)`
...
- Source path parity: YES
- Incoming interactions: 5
  - `src/screens/home/PartnerCoreIdentitiesScreen.tsx:226` via `replace(PartnerReadings)`
...
- Source path parity: YES
- Incoming interactions: 4
  - `src/screens/home/MyLibraryScreen.tsx:278` via `navigate(PeopleList)`
  - `src/screens/home/PersonProfileScreen.tsx:258` via `navigate(PeopleList)`
  - `src/screens/home/PersonReadingsScreen.tsx:246` via `navigate(PeopleList)`
...
- Incoming interactions: 2
  ...
  - `src/screens/home/PersonReadingsScreen.tsx:243` via `navigate(PersonProfile)`
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/home/PersonProfileScreen.tsx:188` via `navigate(PersonReadings)`
- Outgoing route targets: `JobDetail`, `PeopleList`, `PersonProfile`, `SystemsOverview`
- Services: `@/services/jobStatus`
- Stores: `@/store/profileStore`
- Hooks: _none_
- Contexts: _none_
...
- Incoming interactions: 3
  ...
  - `src/screens/home/SystemSelectionScreen.tsx:151` via `navigate(PersonalContext)`
...
- Source path parity: YES
- Incoming interactions: 2
  - `src/screens/home/SynastryOptionsScreen.tsx:74` via `navigate(RelationshipContext)`
  - `src/screens/home/SystemSelectionScreen.tsx:149` via `navigate(RelationshipContext)`
- Outgoing route targets: `SystemSelection`, `VoiceSelection`
- Services: _none_
- Stores: _none_
- Hooks: _none_
...
- Source path parity: YES
- Incoming interactions: 2
  - `src/screens/home/PersonProfileScreen.tsx:202` via `navigate(SynastryOptions)`
  - `src/screens/home/SynastryPreviewScreen.tsx:530` via `navigate(SynastryOptions)`
...
- Source path parity: YES
- Incoming interactions: 2
  - `src/screens/home/PartnerReadingsScreen.tsx:140` via `navigate(SynastryPreview)`
  - `src/screens/home/PersonProfileScreen.tsx:234` via `navigate(SynastryPreview)`
- Outgoing route targets: `SynastryOptions`
- Services: `@/services/coupleImageService`
- Stores: `@/store/authStore`, `@/store/onboardingStore`, `@/store/profileStore`
- Hooks: _none_
- Contexts: _none_
...
- Source path parity: YES
- Incoming interactions: 2
  - `src/screens/home/MyLibraryScreen.tsx:177` via `navigate(YourChart)`
  - `src/screens/settings/SettingsScreen.tsx:206` via `navigate(YourChart)`
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:271` via `navigate(About)`
- Outgoing route targets: _none_
- Services: _none_
- Stores: _none_
- Hooks: _none_
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:295` via `navigate(AccountDeletion)`
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:265` via `navigate(ContactSupport)`
- Outgoing route targets: _none_
- Services: _none_
- Stores: _none_
- Hooks: _none_
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:242` via `navigate(DataPrivacy)`
- Outgoing route targets: _none_
- Services: _none_
- Stores: _none_
- Hooks: _none_
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:248` via `navigate(PrivacyPolicy)`
- Outgoing route targets: _none_
- Services: _none_
- Stores: _none_
- Hooks: _none_
...
- Source path parity: YES
- Incoming interactions: 1
  - `src/screens/settings/SettingsScreen.tsx:254` via `navigate(TermsOfService)`
- Outgoing route targets: _none_
- Services: _none_
- Stores: _none_
- Hooks: _none_
