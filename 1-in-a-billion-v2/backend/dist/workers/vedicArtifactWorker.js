...
const vedic_audio_generator_1 = require("../services/vedic/vedic_audio.generator");
// Init Clients
const supabase = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
const generator = new vedic_audio_generator_1.VedicAudioGenerator(process.env.OPENAI_API_KEY);
...
async function processNextArtifact() {
    ...
    try {
        ...
        const matchVector = {
            ...
            guna_breakdown: matchRow.breakdown,
            dosha: {
            ...
            verdict_band: matchRow.classification
        };
        ...
        if (!profileA || !profileB)
            throw new Error('Profiles not found in library_people');
...
//# sourceMappingURL=vedicArtifactWorker.js.map