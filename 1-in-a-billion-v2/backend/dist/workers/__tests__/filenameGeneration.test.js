...
function generatePdfFilename(params, docType, system) {
...
function generatePdfTitle(params, docType, system) {
...
describe('Filename Generation', () => {
    ...
    describe('System Display Names', () => {
        test('vedic returns full display name', () => {
            expect((0, systemConfig_1.getSystemDisplayName)('vedic')).toBe('Vedic Astrology (Jyotish)');
        });
        test('western returns full display name', () => {
            expect((0, systemConfig_1.getSystemDisplayName)('western')).toBe('Western Astrology');
        });
        test('human_design returns full display name', () => {
            expect((0, systemConfig_1.getSystemDisplayName)('human_design')).toBe('Human Design');
        });
        test('gene_keys returns full display name', () => {
            expect((0, systemConfig_1.getSystemDisplayName)('gene_keys')).toBe('Gene Keys');
        });
        test('kabbalah returns full display name', () => {
            expect((0, systemConfig_1.getSystemDisplayName)('kabbalah')).toBe('Kabbalah');
        });
    });
});
//# sourceMappingURL=filenameGeneration.test.js.map