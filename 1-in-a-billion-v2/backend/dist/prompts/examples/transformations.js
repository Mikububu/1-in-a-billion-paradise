...
exports.buildTransformationsSection = buildTransformationsSection;
 ...
 */
function buildTransformationsSection(maxExamples = 3) {
    const examples = exports.TRANSFORMATIONS.slice(0, maxExamples);
    let section = `
═══════════════════════════════════════════════════════════════════════════════
