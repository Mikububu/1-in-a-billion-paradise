...
exports.SURREAL_METAPHORS = void 0;
exports.buildSurrealMetaphorsSection = buildSurrealMetaphorsSection;
exports.SURREAL_METAPHORS = [
    {
 ...
 */
function buildSurrealMetaphorsSection() {
    let section = `
═══════════════════════════════════════════════════════════════════════════════
SURREAL METAPHOR ARCHITECTURE
═══════════════════════════════════════════════════════════════════════════════
...
`;
    for (const metaphor of exports.SURREAL_METAPHORS) {
        section += `
**${metaphor.category}:**
...
//# sourceMappingURL=surreal-metaphors.js.map