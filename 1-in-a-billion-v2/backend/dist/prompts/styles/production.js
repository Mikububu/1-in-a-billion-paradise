...
exports.PRODUCTION_STYLE = void 0;
exports.buildProductionStyleSection = buildProductionStyleSection;
const env_1 = require("../../config/env");
exports.PRODUCTION_STYLE = {
 ...
 */
function buildProductionStyleSection() {
    return `
═══════════════════════════════════════════════════════════════════════════════
WRITING STYLE: ${exports.PRODUCTION_STYLE.name}
═══════════════════════════════════════════════════════════════════════════════

${exports.PRODUCTION_STYLE.systemPrompt}

${exports.PRODUCTION_STYLE.tone}

${exports.PRODUCTION_STYLE.voiceRules}

SHADOW EMPHASIS: ${Math.round(exports.PRODUCTION_STYLE.shadowEmphasis * 100)}% of analysis should address shadow, wounds, unconscious patterns.
