...
exports.HUMAN_DESIGN_SYSTEM = void 0;
exports.buildHumanDesignSection = buildHumanDesignSection;
exports.HUMAN_DESIGN_SYSTEM = {
    name: 'Human Design',
    individualCoverage: `
 ...
 */
function buildHumanDesignSection(isRelationship) {
    let section = `
═══════════════════════════════════════════════════════════════════════════════
SYSTEM: ${exports.HUMAN_DESIGN_SYSTEM.name}
═══════════════════════════════════════════════════════════════════════════════

${exports.HUMAN_DESIGN_SYSTEM.individualCoverage}

${exports.HUMAN_DESIGN_SYSTEM.typeDetails}

${exports.HUMAN_DESIGN_SYSTEM.accessibilityNote}

EMPHASIS: ${exports.HUMAN_DESIGN_SYSTEM.emphasis}

${exports.HUMAN_DESIGN_SYSTEM.avoid}
`;
    if (isRelationship) {
        section += exports.HUMAN_DESIGN_SYSTEM.synastryAdditions;
    }
    return section;
}
//# sourceMappingURL=human-design.js.map