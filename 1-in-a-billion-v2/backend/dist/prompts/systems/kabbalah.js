...
exports.KABBALAH_SYSTEM = void 0;
exports.buildKabbalahSection = buildKabbalahSection;
exports.KABBALAH_SYSTEM = {
 ...
 */
function buildKabbalahSection(isRelationship) {
    let section = `
${exports.KABBALAH_SYSTEM.criticalWarning}

═══════════════════════════════════════════════════════════════════════════════
SYSTEM: ${exports.KABBALAH_SYSTEM.name}
═══════════════════════════════════════════════════════════════════════════════

${exports.KABBALAH_SYSTEM.individualCoverage}

${exports.KABBALAH_SYSTEM.sephirothReference}

${exports.KABBALAH_SYSTEM.accessibilityNote}

EMPHASIS: ${exports.KABBALAH_SYSTEM.emphasis}

${exports.KABBALAH_SYSTEM.avoid}
`;
    if (isRelationship) {
        section += exports.KABBALAH_SYSTEM.synastryAdditions;
    }
    return section;
}
//# sourceMappingURL=kabbalah.js.map