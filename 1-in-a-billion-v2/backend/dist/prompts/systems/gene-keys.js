...
exports.GENE_KEYS_SYSTEM = void 0;
exports.buildGeneKeysSection = buildGeneKeysSection;
exports.GENE_KEYS_SYSTEM = {
    name: 'Gene Keys',
    individualCoverage: `
 ...
 */
function buildGeneKeysSection(isRelationship) {
    let section = `
═══════════════════════════════════════════════════════════════════════════════
SYSTEM: ${exports.GENE_KEYS_SYSTEM.name}
═══════════════════════════════════════════════════════════════════════════════

${exports.GENE_KEYS_SYSTEM.individualCoverage}

${exports.GENE_KEYS_SYSTEM.terminology}

${exports.GENE_KEYS_SYSTEM.accessibilityNote}

EMPHASIS: ${exports.GENE_KEYS_SYSTEM.emphasis}

${exports.GENE_KEYS_SYSTEM.avoid}
`;
    if (isRelationship) {
        section += exports.GENE_KEYS_SYSTEM.synastryAdditions;
    }
    return section;
}
//# sourceMappingURL=gene-keys.js.map