...
exports.RELATIONSHIP_STATUS_RULES = exports.VOICE_RULES_DEEP_DIVE = exports.OUTPUT_FORMAT_RULES = void 0;
exports.getVoiceRules = getVoiceRules;
exports.buildOutputRulesSection = buildOutputRulesSection;
/**
 * Core output formatting rules
 */
exports.OUTPUT_FORMAT_RULES = `
 ...
 */
function getVoiceRules(voiceMode, personName) {
    if (voiceMode === 'self') {
        return `
VOICE:
 ...
 */
exports.RELATIONSHIP_STATUS_RULES = `
 ...
 */
function buildOutputRulesSection(readingType, voiceMode, personName) {
    let rules = exports.OUTPUT_FORMAT_RULES;
    ...
    if (readingType === 'individual' && voiceMode && personName) {
        ...
        rules += exports.VOICE_RULES_DEEP_DIVE;
    }
    // Add relationship status rules for overlays/nuclear
    if (readingType === 'overlay' || readingType === 'nuclear') {
        rules += exports.RELATIONSHIP_STATUS_RULES;
    }
    return rules;
}
//# sourceMappingURL=output-rules.js.map