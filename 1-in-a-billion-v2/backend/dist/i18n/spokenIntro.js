...
exports.buildLocalizedSpokenIntro = buildLocalizedSpokenIntro;
function getSystemDisplayName(system, lang) {
    ...
    if (lang === 'de') {
        ...
        if (lower === 'western')
            return 'Astrología Occidental';
        if (lower === 'vedic')
            return 'Astrología Védica';
        if (lower === 'human_design')
            return 'Diseño Humano';
        if (lower === 'gene_keys')
            return 'Claves Genéticas';
        if (lower === 'kabbalah')
            return 'Cábala';
    }
    else if (lang === 'fr') {
        ...
        if (lower === 'vedic')
            return 'Astrologie Védique';
        if (lower === 'human_design')
            return 'Design Humain';
        if (lower === 'gene_keys')
            return 'Clés Génétiques';
        if (lower === 'kabbalah')
            return 'Kabbale';
    }
    else if (lang === 'zh') {
        ...
        if (lower === 'western')
            return 'Astrologia Ocidental';
        if (lower === 'vedic')
            return 'Astrologia Védica';
        if (lower === 'human_design')
            return 'Design Humano';
        if (lower === 'gene_keys')
            return 'Gene Keys';
        if (lower === 'kabbalah')
            return 'Cabala';
        ...
        if (lower === 'western')
            return 'Astrologia Occidentale';
        if (lower === 'vedic')
            return 'Astrologia Vedica';
        if (lower === 'human_design')
            return 'Human Design';
        if (lower === 'gene_keys')
            return 'Gene Keys';
...
function buildLocalizedSpokenIntro(options) {
...
//# sourceMappingURL=spokenIntro.js.map