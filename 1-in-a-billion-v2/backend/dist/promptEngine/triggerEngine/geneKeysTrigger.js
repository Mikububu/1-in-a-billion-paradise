...
exports.stripGeneKeysChartData = stripGeneKeysChartData;
exports.buildGeneKeysTriggerPrompt = buildGeneKeysTriggerPrompt;
exports.buildGeneKeysWritingPrompt = buildGeneKeysWritingPrompt;
const triggerConfig_1 = require("./triggerConfig");
const gene_keys_1 = require("../../prompts/systems/gene-keys");
/**
 ...
 */
function stripGeneKeysChartData(raw) {
...
// ─── 2. TRIGGER PROMPT ───────────────────────────────────────────────────────
function buildGeneKeysTriggerPrompt(params) {
...
// ─── 3. WRITING PROMPT ───────────────────────────────────────────────────────
function buildGeneKeysWritingPrompt(params) {
    ...
    const geneKeysGuidance = (0, gene_keys_1.buildGeneKeysSection)(false);
    return [
...
//# sourceMappingURL=geneKeysTrigger.js.map