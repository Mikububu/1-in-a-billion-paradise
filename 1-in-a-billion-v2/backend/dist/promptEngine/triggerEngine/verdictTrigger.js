...
exports.stripVerdictChartData = stripVerdictChartData;
exports.buildVerdictTriggerPrompt = buildVerdictTriggerPrompt;
exports.buildVerdictWritingPrompt = buildVerdictWritingPrompt;
 ...
 */
function stripVerdictChartData(raw) {
    ...
    for (const line of lines) {
        ...
        if (!t)
            continue;
        if (keptInSection >= MAX_LINES_PER_SECTION)
            continue;
        out.push(line);
        keptInSection += 1;
    }
...
function buildVerdictTriggerPrompt(params) {
 ...
 */
function buildVerdictWritingPrompt(params) {
...
//# sourceMappingURL=verdictTrigger.js.map