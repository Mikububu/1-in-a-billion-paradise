...
exports.phoneticizeTextForTTS = phoneticizeTextForTTS;
 ...
 */
async function phoneticizeTextForTTS(text, language) {
    if (!text || language === 'en')
        return text;
...
`;
    try {
        const rawContent = await llm_1.llm.generate(`${systemPrompt}\n\nTEXT:\n${text}`, 'phoneticizer', { temperature: 0.1, maxTokens: 800 } // Keep it strict and fast
        );
...
//# sourceMappingURL=phoneticizer.js.map