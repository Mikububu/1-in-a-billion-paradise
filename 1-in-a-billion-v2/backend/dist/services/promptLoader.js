...
exports.loadMasterPrompt = loadMasterPrompt;
exports.extractSection = extractSection;
exports.getForbiddenPhrases = getForbiddenPhrases;
exports.getVoiceLock = getVoiceLock;
exports.getOutputFormat = getOutputFormat;
exports.getCondensedVoice = getCondensedVoice;
exports.buildDeepReadingPrompt = buildDeepReadingPrompt;
...
function loadMasterPrompt() {
    ...
    // Assuming this file is in src/services/, so ../../prompts/ finds it in root/prompts/
 ...
 */
function extractSection(partNumber) {
 ...
 */
function buildDeepReadingPrompt(params) {
    const { person1Name, person2Name, person1Data, person2Data, chartData, spiceLevel, readingType, systemName, wordTarget = 4000, outputLanguage = languages_1.DEFAULT_OUTPUT_LANGUAGE } = params;
...
`;
    ...
    // Combine everything
    // Note: We append instructions at the VERY END to ensure recent recency bias
    return `
${masterPrompt}
