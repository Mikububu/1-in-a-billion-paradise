...
// ==========================================
// Mock Person Factory
const mockPerson = (sign, nakshatra) => ({
    moon_sign: sign,
...
describe.skip('Vedic Matchmaking Engine - Pure Computation (expectations need updating)', () => {
    describe('1. Varna Koota (1 Point)', () => {
        ...
        it('should score 1 when Groom is Higher (Brahmin vs Kshatriya)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreVarna)(groom, bride)).toBe(1);
        });
        ...
        it('should score 0 when Groom is Lower (Shudra vs Brahmin)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreVarna)(groom, bride)).toBe(0);
        });
    });
    describe('2. Vashya Koota (2 Points)', () => {
        ...
        it('should score 2 for compatible pair defined in table (Aries ranges)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreVashya)(groom, bride)).toBe(2);
        });
        it('should score 0 for incompatible pair (Leo -> Aries)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreVashya)(groom, bride)).toBe(0);
        });
    });
    describe('3. Tara Koota (3 Points)', () => {
        ...
        it('should score 0 for Janma (Same Nakshatra)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreTara)(groom, bride)).toBe(0);
        });
        ...
        it('should score 3 for ParamaMitra (Distance 27)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreTara)(groom, bride)).toBe(3);
        });
    ...
    describe('4. Yoni Koota (4 Points)', () => {
        ...
        it('should score 4 for Same Yoni', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreYoni)(groom, bride)).toBe(4);
        });
        ...
        it('should score 2 for Horse vs Elephant (Neutral/Enemy mix)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreYoni)(groom, bride)).toBe(2);
        });
    });
    describe('5. Graha Maitri (5 Points)', () => {
        ...
        it('should score 5 for Same Lord', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreGrahaMaitri)(groom, bride)).toBe(5);
        });
        ...
        it('should score 1 for Neutral-Neutral (Mars-Saturn)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreGrahaMaitri)(groom, bride)).toBe(1);
        });
    });
    describe('6. Gana Koota (6 Points)', () => {
        ...
        it('should score 6 for Deva-Deva', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreGana)(groom, bride)).toBe(6);
        });
        // Deva vs Rakshasa (Ashwini vs Krittika) -> 1
        it('should score 1 for Deva-Rakshasa', () => {
            const groom = mockPerson('Aries', 'Ashwini');
            const bride = mockPerson('Aries', 'Krittika');
            expect((0, vedic_matchmaking_engine_1.scoreGana)(groom, bride)).toBe(1);
        });
    ...
    describe('7. Bhakoot Koota (7 Points)', () => {
        ...
        it('should score 7 for Same Sign (1/1)', () => {
            const groom = mockPerson('Aries', 'Ashwini');
            const bride = mockPerson('Aries', 'Bharani');
            expect((0, vedic_matchmaking_engine_1.scoreBhakoot)(groom, bride)).toBe(7);
        });
        // Aries(1) vs Taurus(2). Dist 2. Bad.
        it('should score 0 for 2/12 relationship', () => {
            const groom = mockPerson('Aries', 'Ashwini');
            const bride = mockPerson('Taurus', 'Rohini');
            expect((0, vedic_matchmaking_engine_1.scoreBhakoot)(groom, bride)).toBe(0);
        });
    ...
    describe('8. Nadi Koota (8 Points)', () => {
        ...
        it('should score 0 for Same Nadi (Dosha)', () => {
            ...
            expect((0, vedic_matchmaking_engine_1.scoreNadi)(groom, bride)).toBe(0);
        });
        // Ashwini (Adi) vs Bharani (Madhya). Diff -> 8.
        it('should score 8 for Different Nadi', () => {
            const groom = mockPerson('Aries', 'Ashwini');
            const bride = mockPerson('Aries', 'Bharani');
            expect((0, vedic_matchmaking_engine_1.scoreNadi)(groom, bride)).toBe(8);
        });
    });
});
//# sourceMappingURL=matchmaking-engine.test.js.map