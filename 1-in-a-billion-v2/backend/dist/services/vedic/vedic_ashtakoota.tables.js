...
exports.NADI_BY_NAKSHATRA = exports.NADI_TABLE = exports.NAKSHATRA_TO_NADI = exports.BHAKOOT_BAD_DISTANCES = exports.BHAKOOT_TABLE = exports.GANA_SCORE = exports.GANA_BY_NAKSHATRA = exports.GANA_MATRIX = exports.GANA_TABLE = exports.NAKSHATRA_TO_GANA = exports.RASHI_LORDS = exports.MAITRI_SCORE = exports.GRAHA_MAITRI_TABLE = exports.PLANET_FRIENDSHIP = exports.RASHI_LORD = exports.FULL_YONI_MATRIX = exports.YONI_SCORE_MATRIX = exports.YONI_BY_NAKSHATRA = exports.YONI_MATRIX = exports.YONI_TABLE = exports.NAKSHATRA_TO_YONI = exports.TARA_SCORE = exports.TARA_TABLE = exports.VASHYA_TABLE = exports.RASHI_VARNA_MAP = exports.VARNA_TABLE = exports.RASHI_TO_VARNA = exports.VARNA_HIERARCHY = exports.VARNA_BY_SIGN = exports.TOTAL_GUNAS = void 0;
exports.varnaScore = varnaScore;
exports.taraScore = taraScore;
exports.grahaMaitriScore = grahaMaitriScore;
exports.bhakootScore = bhakootScore;
/* =====================================================
   CONSTANTS
===================================================== */
exports.TOTAL_GUNAS = 36;
/* =====================================================
   VARNA (1)
   Based on Moon Rashi
===================================================== */
// Map of moon sign names to varna values for vedic_matchmaking.engine.ts
exports.VARNA_BY_SIGN = {
    'Aries': 'kshatriya',
    'Taurus': 'vaishya',
    'Gemini': 'shudra',
    'Cancer': 'brahmin',
...
exports.VARNA_HIERARCHY = ['shudra', 'vaishya', 'kshatriya', 'brahmin'];
exports.RASHI_TO_VARNA = [
    0, // Aries      Kshatriya
    1, // Taurus     Vaishya
    2, // Gemini     Shudra
    0, // Cancer     Brahmin
...
function varnaScore(male, female) {
    return male >= female ? 1 : 0;
}
// Derived Matrix for Engine O(1) Lookup
exports.VARNA_TABLE = Array.from({ length: 12 }, (_, m) => Array.from({ length: 12 }, (_, f) => varnaScore(exports.RASHI_TO_VARNA[m], exports.RASHI_TO_VARNA[f])));
// Alias for backward compatibility
exports.RASHI_VARNA_MAP = exports.RASHI_TO_VARNA;
/* =====================================================
   VASHYA (2)
===================================================== */
// Renaming export to match Engine expectation (VASHYA_TABLE) or update engine to VASHYA_MATRIX
exports.VASHYA_TABLE = [
...
function taraScore(nakA, nakB) {
    ...
    if ([0, 2, 4, 6, 8].includes(d))
        return 3;
    if ([1, 3, 5, 7].includes(d))
        return 1.5; // Updated from 2 to 1.5 as per Step 519 logic? 
...
// Derived Table
exports.TARA_TABLE = Array.from({ length: 27 }, (_, i) => Array.from({ length: 27 }, (_, j) => taraScore(i, j)));
...
exports.FULL_YONI_MATRIX = exports.YONI_MATRIX;
/* =====================================================
   GRAHA MAITRI (5)
===================================================== */
exports.RASHI_LORD = [
...
exports.MAITRI_SCORE = exports.GRAHA_MAITRI_TABLE;
...
function bhakootScore(rashiA, rashiB) {
    ...
    if ([0, 6].includes(diff))
        return 0; // 1-1, 1-7 (Both 7 points usually? 1-7 is good. 1-1 is good).
    // Wait. 1-1 is 7 points. 1-7 is 7 points.
    // 0 distance = Same sign = 7 pts.
    // 6 distance = Opposite = 7 pts.
    if ([2, 10].includes(diff))
        return 0; // 2-12
    if ([5, 9].includes(diff))
        return 0; // 5-9
    return 7;
}
exports.BHAKOOT_TABLE = Array.from({ length: 12 }, (_, i) => Array.from({ length: 12 }, (_, j) => {
    // Re-implementing Step 536 logic here directly
    const diff = (j - i + 12) % 12;
    if ([6].includes(diff))
        return 7; // 7th is favorable
    if ([2, 10].includes(diff))
        return 0; // 2-12 Bad
    if ([5, 9].includes(diff))
        return 0; // 5-9 Bad
    if ([0].includes(diff))
        return 7; // Same Sign Good
    // 3-11, 4-10 are Good.
    return 7;
}));
// Bad distances for Bhakoot dosha
exports.BHAKOOT_BAD_DISTANCES = [2, 5, 9, 10];
/* =====================================================
   NADI (8)
===================================================== */
exports.NAKSHATRA_TO_NADI = [
    0, 1, 2, 0, 1, 2, 0, 1, 2, 0, 1, 2, 0,
    1, 2, 0, 1, 2, 0, 1, 2, 0, 1, 2, 0, 1
];
exports.NADI_TABLE = Array.from({ length: 27 }, (_, i) => Array.from({ length: 27 }, (_, j) => {
    const a = exports.NAKSHATRA_TO_NADI[i] ?? (i % 3);
    const b = exports.NAKSHATRA_TO_NADI[j] ?? (j % 3);
    return a === b ? 0 : 8;
}));
...
/* END FILE */
//# sourceMappingURL=vedic_ashtakoota.tables.js.map