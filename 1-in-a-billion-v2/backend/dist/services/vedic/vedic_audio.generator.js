...
exports.VedicAudioGenerator = void 0;
const axios_1 = __importDefault(require("axios"));
const lamejs = __importStar(require("lamejs"));
const OPENAI_API_URL = 'https://api.openai.com/v1/audio/speech';
const VOICE_ID = 'onyx';
const MODEL_ID = 'tts-1';
const SAMPLE_RATE = 24000;
class VedicAudioGenerator {
    constructor(apiKey) {
        this.apiKey = apiKey;
    }
    generateNarrationScript(match, personA, personB) {
        const fmtScore = (n, max) => `${this.numberToWords(n)} out of ${this.numberToWords(max)}`;
    ...
    async createAudiobook(match, profiles) {
...
exports.VedicAudioGenerator = VedicAudioGenerator;
//# sourceMappingURL=vedic_audio.generator.js.map