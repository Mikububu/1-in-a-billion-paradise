...
exports.getRandomGallery = getRandomGallery;
exports.createMatch = createMatch;
exports.getUserMatches = getUserMatches;
exports.markMatchSeen = markMatchSeen;
 ...
 */
async function getRandomGallery(count = 20, excludeUserId) {
    const supabase = (0, supabaseClient_1.createSupabaseServiceClient)();
    if (!supabase)
        return [];
 ...
 */
async function createMatch(user1Id, user2Id, options) {
    const supabase = (0, supabaseClient_1.createSupabaseServiceClient)();
    if (!supabase)
        return null;
 ...
 */
async function markMatchSeen(matchId, userId) {
    const supabase = (0, supabaseClient_1.createSupabaseServiceClient)();
    if (!supabase)
        return false;
...
async function getUserConversations(userId) {
    ...
    return (data || [])
        .filter((c) => c.match?.user1_id === userId || c.match?.user2_id === userId)
        .map((c) => {
