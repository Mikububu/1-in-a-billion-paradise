...
exports.generateSong = generateSong;
exports.downloadSongAudio = downloadSongAudio;
 ...
 */
async function generateSong(input) {
 ...
 */
async function downloadSongAudio(audioUrl) {
    try {
        const response = await (0, axios_1.default)({
            method: 'GET',
            url: audioUrl,
...
//# sourceMappingURL=songGeneration.js.map