...
exports.GATE_SEQUENCE = exports.GENE_KEYS_DATA = void 0;
exports.tropicalLongitudeToGeneKey = tropicalLongitudeToGeneKey;
exports.calculateGeneKeys = calculateGeneKeys;
// The 64 Gene Keys with Shadow, Gift, Siddhi
exports.GENE_KEYS_DATA = {
 ...
 */
function tropicalLongitudeToGeneKey(longitude) {
    ...
    const geneKey = exports.GATE_SEQUENCE[gateIndex];
    // Get the Shadow/Gift/Siddhi data
    const keyData = exports.GENE_KEYS_DATA[geneKey];
    return {
        geneKey,
        line,
 ...
 */
function calculateGeneKeys(planetaryPositions) {
    const profile = {};
...
//# sourceMappingURL=geneKeysCalculator.js.map