...
exports.generateDramaticTitles = generateDramaticTitles;
 ...
 */
async function generateDramaticTitles(params) {
    const systemNames = {
...
OUTPUT FORMAT (JSON only):
{
  ...
  "songTitle": "..."
    ...
    try {
        ...
        const response = await llm_1.llm.generate(prompt, 'title-generation', {
            maxTokens: 200,
