...
async function main() {
    ...
    const result = {
        ...
        jobsByUserId,
        interpretationHints: {
            ifMultipleAuthUsers: 'If authMatches.length > 1, this indicates duplicate emails in Supabase Auth OR you are pointing at different Supabase projects in different builds.',
            ifNoProfiles: 'If authMatches exists but profilesByUserId[uid] is empty, the app will look like "no people" because everything is keyed off user_id in library_people/jobs.',
        },
    };
...
//# sourceMappingURL=investigateAccountByEmail.js.map