...
exports.LANGUAGE_CONFIG = exports.DEFAULT_OUTPUT_LANGUAGE = exports.OUTPUT_LANGUAGES = void 0;
 ...
 */
exports.OUTPUT_LANGUAGES = ['en', 'de', 'es', 'fr', 'zh', 'ja', 'ko', 'hi', 'pt', 'it'];
/**
 * Default output language for all readings.
 */
exports.DEFAULT_OUTPUT_LANGUAGE = 'en';
/**
...
function isValidLanguage(lang) {
    return exports.OUTPUT_LANGUAGES.includes(lang);
}
/**
...
function getLanguageInstruction(lang) {
    return exports.LANGUAGE_CONFIG[lang]?.promptInstruction || '';
}
/**
 * Get BCP-47 locale for a language.
 */
function getLocale(lang) {
    return exports.LANGUAGE_CONFIG[lang]?.locale || 'en-US';
}
/**
...
function parseLanguage(input) {
    ...
    return exports.DEFAULT_OUTPUT_LANGUAGE;
}
