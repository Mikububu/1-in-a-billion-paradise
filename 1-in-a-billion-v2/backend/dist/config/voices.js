 ...
 */
exports.VOICE_CLONE_TRANSCRIPT = `My first vision of earth was water veiled. I am of the race of men and women who see things through this curtain of sea, and my eyes are the color of water.`;
/**
...
function getVoiceById(id) {
    return exports.VOICES.find((v) => v.id === id && v.enabled !== false);
}
/**
 * Get all enabled voices
 */
function getEnabledVoices() {
    return exports.VOICES.filter((v) => v.enabled !== false);
}
/**
 ...
 */
function isTurboPresetVoice(voiceId) {
    const voice = getVoiceById(voiceId);
...
function getCustomVoices() {
    return exports.VOICES.filter((v) => v.enabled !== false && !v.isTurboPreset);
}
/**
 * Get Turbo preset voices only
 */
function getTurboPresetVoices() {
    return exports.VOICES.filter((v) => v.enabled !== false && v.isTurboPreset === true);
}
