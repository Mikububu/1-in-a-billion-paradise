...
export function buildHDTriggerPrompt(params: {
  ...
  return [
    ...
    'Third person. Use Human Design terms only when needed and explain first use in plain language. No repair instructions. No softening.',
...
export function buildHDWritingPrompt(params: {
  ...
  return [
    ...
    '- Use center/channel/gate language only when it carries concrete evidence.',
