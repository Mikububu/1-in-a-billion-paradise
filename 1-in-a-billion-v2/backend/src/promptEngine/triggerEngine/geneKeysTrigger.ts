...
export function buildGeneKeysTriggerPrompt(params: {
  ...
  return [
    ...
    'Third person. Use Gene Keys terms only when needed and explain first use in plain language. No repair instructions. No softening.',
...
export function buildGeneKeysWritingPrompt(params: {
  ...
  return [
    ...
    '- Use key/sphere/frequency language only when it carries concrete evidence.',
