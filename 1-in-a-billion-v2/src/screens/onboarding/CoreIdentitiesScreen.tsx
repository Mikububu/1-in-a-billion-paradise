...
export const CoreIdentitiesScreen = ({ navigation }: Props) => {
  ...
  const runSequence = async () => {
    ...
    try {
      ...
      const sunFetchPromise = readingsApi.sun(payload as any).then((data: any) => {
      ...
      const moonFetchPromise = readingsApi.moon(payload as any).then((data: any) => {
        if (!data?.reading) return;
      ...
      const risingFetchPromise = readingsApi.rising(payload as any).then((data: any) => {
        if (!data?.reading) return;
