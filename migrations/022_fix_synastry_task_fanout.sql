-- ═══════════════════════════════════════════════════════════════════════════
-- MIGRATION 022: FIX SYNASTRY TASK FAN-OUT (3 DOCS PER SYSTEM, NO VERDICT)
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Product contract:
-- - synastry (single-system overlay purchase): 3 docs per system
--   (person1, person2, overlay)  → NO Final Verdict
-- - nuclear_v2: 15 docs (5 systems × 3) + 1 Final Verdict = 16
--
-- This migration updates auto_create_job_tasks() so synastry jobs create
-- person1/person2/overlay tasks (matching PRICING.md: 3 API calls).
--
BEGIN;
