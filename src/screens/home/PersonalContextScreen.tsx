...
export const PersonalContextScreen = ({ navigation, route }: Props) => {
    const { personName = 'You', productType, systems = [], ...restParams } = (route.params || {}) as any;
    ...
    const headline = isKabbalahActive
        ...
        : `${personName}, would you like to focus on something specific in your reading?`;

    const subline = isKabbalahActive
        ? 'Please include your real first name and surname. Key moments, exact dates, and places make this reading much stronger.'
        : 'Share any question, feeling, or life area you want the reading to focus on.';
