...
export const SignInScreen = () => {
    ...
    const finalizeSignInAccess = useCallback(async () => {
        ...
        // Product rule: keep dashboard access even when subscription is inactive.
        setEntitlementState(verification.success ? 'inactive' : 'unknown');
        setHasCompletedOnboarding(true);
        setShowDashboard(true);
        return true;
    }, [setEntitlementState, setHasCompletedOnboarding, setShowDashboard]);
