...
export function buildHDTriggerPrompt(params: {
  ...
  return [
    ...
    '',
    TRIGGER_WORD_RULE,
    'Third person. Use selective Human Design language (type, authority, center, channel, gate) only when needed, and explain each term in plain words immediately.',
    ...
    '',
    'Do not describe the system as a manual. Do not list centers or channels mechanically.',
...
export function buildHDWritingPrompt(params: {
  ...
  return [
    ...
    'SHADOW & DEPTH:',
    `- ${WRITING_shadow_RULE}`,
    '- The Not-Self is not a concept. It is who they become when they betray their body.',
    ...
    '- Do not dump centers/channels/gates as technical lists without explanation.',
