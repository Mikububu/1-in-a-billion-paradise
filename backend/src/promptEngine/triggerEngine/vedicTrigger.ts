...
export function buildVedicTriggerPrompt(params: {
  ...
  return [
    ...
    '',
    TRIGGER_WORD_RULE,
    'Third person. Use selective Jyotish language (graha, dasha, nakshatra) when needed, and explain each term in plain words immediately.',
    ...
    'Do not stack Sanskrit/Jyotish terms without explanation.',
...
export function buildVedicWritingPrompt(params: {
  ...
  return [
    ...
    'SHADOW & DEPTH:',
    `- ${WRITING_shadow_RULE}`,
    '- Karmic debt is not abstract. Name what it costs in this life.',
    ...
    '- The narrative must build. The Dasha period is the present tense pressure.',
