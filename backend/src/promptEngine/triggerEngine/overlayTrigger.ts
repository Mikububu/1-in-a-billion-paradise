...
function buildOverlayTriggerPromptBase(params: {
  ...
  return [
    ...
    'Use selective system language when needed, and explain terms in plain words immediately.',
    'No repair instructions. Avoid generic reassurance language.',
...
function buildOverlayWritingPromptBase(params: {
  ...
  return [
    ...
    '══════════════════════════════════════════════════════════',
    buildOverlayProvocations(person1Name, person2Name),
    '',
    '══════════════════════════════════════════════════════════',
    ...
    'SHADOW & DEPTH:',
    `- ${WRITING_shadow_RULE}`,
    '- Name what they do to each other that neither would do alone.',
    '- Is this a doorway to liberation or a trapdoor to mutual destruction? Say which.',
    '',
    'STRUCTURE:',
